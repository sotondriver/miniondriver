...
if __name__ == '__main__':
    ...
    save_data_into_mongodb(dididata, m.WEATHER_IN_PATH, m.WEATHER_NAMES, collection='test_weather_data')
    # save_data_into_mongodb(dididata, m.ORDER_IN_PATH, m.ORDER_NAMES, collection='test_order_data', clean=True)
    # save_csv_into_mongodb(dididata, m.TRAFFIC_OUT_PATH, collection='test_traffic_data')
